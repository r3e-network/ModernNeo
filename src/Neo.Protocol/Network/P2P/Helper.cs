...
{
    /// <summary>
    /// A helper class for <see cref="IVerifiableBase"/>.
    /// </summary>
    public static class Helper
    {
        ...
        /// <summary>
        /// Calculates the hash of a <see cref="IVerifiableBase"/>.
        /// </summary>
        /// <param name="verifiable">The <see cref="IVerifiableBase"/> object to hash.</param>
        /// <returns>The hash of the object.</returns>
        public static UInt256 CalculateHash(this IVerifiableBase verifiable)
        {
        ...
        /// </returns>
        public static bool TryGetHash(this IVerifiableBase verifiable, [NotNullWhen(true)] out UInt256? hash)
        {
            try
            {
        ...
        /// <summary>
        /// Gets the data of a <see cref="IVerifiableBase"/> object to be hashed.
        /// </summary>
        /// <param name="verifiable">The <see cref="IVerifiableBase"/> object to hash.</param>
        /// <param name="network">The magic number of the network.</param>
        /// <returns>The data to hash.</returns>
        public static byte[] GetSignData(this IVerifiableBase verifiable, uint network) => GetSignData(verifiable.Hash, network);
