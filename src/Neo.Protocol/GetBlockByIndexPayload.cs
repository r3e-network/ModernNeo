...
namespace Neo.Network.P2P.Payloads
{
    ...
    {
        /// <summary>
        /// Indicates the maximum number of headers allowed in GetHeaders responses.
        /// Kept here to avoid pulling in Header-dependent payload types into Neo.Protocol.
        /// </summary>
        ...
        void ISerializable.Deserialize(ref MemoryReader reader)
        {
            ...
            if (Count < -1 || Count == 0 || Count > MaxHeadersCount)
                throw new FormatException($"Invalid count: {Count}/{MaxHeadersCount}.");
        }
