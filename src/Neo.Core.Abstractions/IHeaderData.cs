...
{
    /// <summary>
    /// Represents immutable block header data in the Neo blockchain.
    /// This interface provides read-only access to header properties
    ...
    public interface IHeaderData
    {
        ...
        /// <summary>
        /// Gets the witness for this header.
        /// </summary>
        IWitnessData? Witness { get; }
    }
}
