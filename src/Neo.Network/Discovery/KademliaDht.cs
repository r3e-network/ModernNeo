...
namespace Neo.Network.Discovery
{
    ...
    public sealed class KademliaDht : IPeerDiscovery
    {
        ...
        private readonly IDhtRpcService? _rpcService;
        ...
        /// </summary>
        /// <param name="options">DHT configuration options.</param>
        /// <param name="rpcService">Optional RPC service for network operations. If null, DHT operates in local-only mode.</param>
        public KademliaDht(KademliaDhtOptions? options = null, IDhtRpcService? rpcService = null)
        {
        ...
        // Network operations - delegate to injected RPC service
        private Task<IEnumerable<PeerInfo>?> QueryFindNodeAsync(PeerInfo peer, byte[] targetId, CancellationToken cancellationToken)
        {
            ...
            return _rpcService.FindNodeAsync(peer, targetId, cancellationToken);
        }
        ...
        private Task<IEnumerable<PeerInfo>?> QueryGetProvidersAsync(PeerInfo peer, byte[] key, CancellationToken cancellationToken)
        {
            ...
            return _rpcService.GetProvidersAsync(peer, key, cancellationToken);
        }
        ...
        private Task SendAddProviderAsync(PeerInfo peer, byte[] key, PeerInfo provider, CancellationToken cancellationToken)
        {
            ...
            return _rpcService.AddProviderAsync(peer, key, provider, cancellationToken);
        }
