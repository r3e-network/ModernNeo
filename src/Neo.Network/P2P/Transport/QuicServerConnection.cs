...
{
    /// <summary>
    /// Bridges a server-accepted QUIC peer connection for P2P messaging.
    /// </summary>
    [SupportedOSPlatform("linux")]
    [SupportedOSPlatform("windows")]
    [SupportedOSPlatform("osx")]
    public sealed class QuicServerConnection : Neo.P2P.Abstractions.IProtocolBridge, Neo.P2P.Abstractions.IProtocolConnection, IDisposable
    {
        ...
        public void Initialize(IQuicConnection connection)
        {
