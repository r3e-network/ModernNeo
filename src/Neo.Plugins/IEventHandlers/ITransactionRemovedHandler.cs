...
namespace Neo.IEventHandlers
{
    ...
    {
        /// <summary>
        /// Handler of TransactionRemoved event from <see cref="IMemoryPool"/>.
        /// Triggered when a transaction is removed from the memory pool.
        /// </summary>
        /// <param name="sender">The source of the event</param>
        /// <param name="tx">The arguments of event that removes a transaction from the memory pool.</param>
