...
namespace Neo.IEventHandlers
{
    ...
    {
        /// <summary>
        /// The handler of TransactionAdded event from the <see cref="IMemoryPool"/>.
        /// Triggered when a transaction is added to the memory pool.
        /// </summary>
        /// <param name="sender">The source of the event</param>
        /// <param name="tx">The transaction added to the memory pool.</param>
